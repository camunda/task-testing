...
describe('TaskExecution', function() {
  ...
  it('should execute a task (single poll)', inject(async function(elementRegistry) {
    ...
    expect(api.getProcessInstanceJobs).to.have.been.calledWithMatch(DEFAULT_PROCESS_INSTANCE_KEY);
    expect(api.getProcessInstanceMessageSubscriptions).to.have.been.calledOnce;
    expect(api.getProcessInstanceMessageSubscriptions).to.have.been.calledWithMatch(DEFAULT_PROCESS_INSTANCE_KEY);
    expect(api.getProcessInstanceUserTasks).to.have.been.calledOnce;
    expect(api.getProcessInstanceUserTasks).to.have.been.calledWithMatch(DEFAULT_PROCESS_INSTANCE_KEY);
