      ...
      <div className="task-testing__container">
        <div className={ `task-testing__container--header ${getHeaderStateClass({ isTaskExecuting, isConnectionConfigured, inputError, output })}` }>
          <div className="task-testing__header-actions">
            ...
            >
              <Button
                ...
                kind={ isTaskExecuting || !isConnectionConfigured || !!inputError ? 'secondary' : 'primary' }
                size="sm"
          ...
          <div className="task-testing__header-actions-right">
            <Tooltip className="show-tooltip" label="Clear result" align="bottom-end">
              <Button
                kind="ghost"
                size="sm"
                hasIconOnly
            ...
            {
              onConfigureConnection && <Tooltip className="show-tooltip" label={ isConnectionConfigured ? 'Configure connection' : configureConnectionLabel } align="bottom-end">
                <Button
