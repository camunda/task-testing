 ...
 * @param {import('../types.d.ts').Variables} resolvedVariables
 * @param {import('../types.d.ts').Input} inputProp
 *
 * @returns {{
 *   input: import('../types.d.ts').Input,
 *   setInput: Function,
 *   reset: Function
 * }}
 */
export function useInput(element, resolvedVariables, inputProp = {}) {
