...
export const SINGLE_TASK_SELECTION_REQUIRED_MESSAGE = 'Select a task or sub process to start testing.';
export const TASK_SELECTION_REQUIRED_MESSAGE = 'Task testing is only supported for tasks and sub processes. Select a task or sub process to start testing.';
