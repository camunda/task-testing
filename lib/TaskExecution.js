...
export default class TaskExecution extends EventEmitter {
  ...
  async executeTask(element, variables) {
    ...
    const intervalCallback = async () => {
      ...
      console.log('Element instances', getProcessInstanceElementInstancesResult);
      ...
      this._emit('taskExecution.update', { processInstance, elementInstances: getProcessInstanceElementInstancesResult.response });
