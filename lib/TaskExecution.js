...
export default class TaskExecution extends EventEmitter {
  ...
  async cancelTaskExecution() {
    ...
    this.emitStatusChange(undefined);
  }
  ...
  async executeTask(elementId, variables) {
    ...
    this.emitStatusChange('deploying');
    ...
    this.emitStatusChange('starting-instance');
  ...
  emitStatusChange(status) {
    this.emit('taskExecution.statusChanged', status);
  }
}
