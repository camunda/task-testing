...
export default class TaskExecution extends EventEmitter {
  ...
  async executeTask(elementId, variables) {
    ...
    if (!deploymentResponse.success) {
      this.emitError('Failed to deploy process definition', deploymentResponse.error);
    ...
    if (!startInstanceResponse.success) {
      this.emitError('Failed to start process instance', startInstanceResponse.error);
